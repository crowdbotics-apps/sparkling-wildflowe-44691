...
## Project Structure
    ...
    ├── sparkling_wildflowe_44691  # Django project configurations
...
1. Clone this repo and `cd sparkling_wildflowe_44691`
...
2. Clone this repo and `cd sparkling_wildflowe_44691`
